...
export const contentFr: Content = {
  ...
  speakers: [
    { name: 'Wassim El Ahmar', focus: 'Apprentissage automatique et vision par ordinateur', bio: 'L\'avenir de l\'ingénieur à l\'ère de l\'IA', image: '/speakers/wassim-el-ahmar.jpeg', linkedin: 'https://www.linkedin.com/in/wassimea/', id: 'wassim' },
    { name: 'Peter Oliha', focus: 'Lead Backend Engineer | Fondateur SaaS • APIs et Cloud', bio: 'De l\'optimisation au choix', image: '/speakers/peter-oliha.png', linkedin: 'https://www.linkedin.com/in/peter-o-oliha-93b27118b/', id: 'peter' },
    { name: 'Jude Bennett', focus: 'Développement logiciel', bio: 'Coder les cieux', image: '/speakers/jude-bennett.jpg', id: 'jude' },
    { name: 'Yousef Rafique', focus: 'Ingénierie conseil - Automatisation et IA', bio: 'Construire avec intention : pour qui construisons-nous vraiment?', image: '/speakers/yousef-rafique.png', linkedin: 'https://www.linkedin.com/in/yousefrafique/', id: 'yousef' },
    { name: 'Alfredo Herrera', focus: 'Consultant en circuits intégrés numériques', bio: 'Sur le vérificateur accidentel', image: '/speakers/alfredo-herrera.jpeg', linkedin: 'https://www.linkedin.com/in/alfredoherreraeng/', id: 'alfredo' },
    { name: 'Matthew Jerabek', focus: 'Gestion de l\'innovation et de l\'entrepreneuriat', bio: 'Sur l\'ÉCHEC', image: '/speakers/matthew-jerabek.png', linkedin: 'https://www.linkedin.com/in/matthewjerabek/', id: 'jerabek' },
    { name: 'Stephen Gagné', focus: 'Aider les entrepreneurs étudiants à transformer des idées audacieuses en résultats.', bio: 'Écrire du code est la dernière chose que vous devriez faire', image: '/speakers/stephen-gagne.png', linkedin: 'https://www.linkedin.com/in/stephengagne/', id: 'stephen' },
    { name: 'Dan Cooper', focus: 'Architecte TI en chef, Gouvernement du Canada', bio: 'Sur l\'architecture de systèmes à l\'échelle gouvernementale et ce que signifie construire des technologies à l\'échelle nationale', image: '/speakers/dan-cooper.png', linkedin: 'https://www.linkedin.com/in/thedancooper/', id: 'dan' },
  ],
  schedule: {
