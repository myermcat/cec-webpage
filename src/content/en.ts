...
export const contentEn: Content = {
  ...
  speakers: [
    { name: 'Wassim El Ahmar', focus: 'Machine learning and computer vision', bio: 'On an Engineer\'s Future in the era of AI', image: '/speakers/wassim-el-ahmar.jpeg', linkedin: 'https://www.linkedin.com/in/wassimea/', id: 'wassim' },
    { name: 'Peter Oliha', focus: 'Lead Backend Engineer | SaaS Founder • APIs & Cloud', bio: 'From Optimization to Choice', image: '/speakers/peter-oliha.png', linkedin: 'https://www.linkedin.com/in/peter-o-oliha-93b27118b/', id: 'peter' },
    { name: 'Jude Bennett', focus: 'Software development', bio: 'On coding the skies', image: '/speakers/jude-bennett.jpg', id: 'jude' },
    { name: 'Yousef Rafique', focus: 'Consulting Engineering - Automation & AI', bio: 'On building with Intention: Who Are We Really Building For?', image: '/speakers/yousef-rafique.png', linkedin: 'https://www.linkedin.com/in/yousefrafique/', id: 'yousef' },
    { name: 'Alfredo Herrera', focus: 'Consultant on digital integrated circuit', bio: 'On The Accidental verifier', image: '/speakers/alfredo-herrera.jpeg', linkedin: 'https://www.linkedin.com/in/alfredoherreraeng/', id: 'alfredo' },
    { name: 'Matthew Jerabek', focus: 'Managing Innovation & Entrepreneurship', bio: 'On FAILURE', image: '/speakers/matthew-jerabek.png', linkedin: 'https://www.linkedin.com/in/matthewjerabek/', id: 'jerabek' },
    { name: 'Stephen Gagné', focus: 'Helping student entrepreneurs turn bold ideas into awesome outcomes.', bio: 'Writing Code Is the Last Thing You Should Do', image: '/speakers/stephen-gagne.png', linkedin: 'https://www.linkedin.com/in/stephengagne/', id: 'stephen' },
    { name: 'Dan Cooper', focus: 'Chief IT Architect, Government of Canada', bio: 'On architecting government-scale systems and what it means to build technology at national scale', image: '/speakers/dan-cooper.png', linkedin: 'https://www.linkedin.com/in/thedancooper/', id: 'dan' },
  ],
  schedule: {
